...
export class SystemuserComponent implements OnInit {
  ...
  delete(systemuser: ISystemuser): void {
    const modalRef = this.modalService.open(SystemuserDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.systemuser = systemuser;
  ...
  protected onSuccess(data: ISystemuser[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
