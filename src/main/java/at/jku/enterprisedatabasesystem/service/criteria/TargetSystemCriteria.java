...
/**
 * Criteria class for the {@link at.jku.enterprisedatabasesystem.domain.TargetSystem} entity. This class is used
 * in {@link at.jku.enterprisedatabasesystem.web.rest.TargetSystemResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /target-systems?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
